  ...
  const navItems = [
    ...
    },
    {
      ...
      dropdown: [
        ...
        { name: 'Food and Beverage', href: '/industries/food-beverage' },
        { name: 'Power Plants', href: '/industries/power-plants' },
        { name: 'Agriculture and Irrigation', href: '/industries/agriculture-irrigation' },
        { name: 'Cement, Textile', href: '/industries/cement-textile' },
        ...
        { name: 'Marine and Chemical', href: '/industries/marine-chemical' },
